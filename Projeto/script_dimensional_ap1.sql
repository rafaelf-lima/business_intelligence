...
CREATE TABLE public.dim_horario (
                sk_horario INTEGER NOT NULL,
                nk_horario TIME NOT NULL,
                hora INTEGER NOT NULL,
                CONSTRAINT sk_horario PRIMARY KEY (sk_horario)
);
...
ALTER TABLE public.ft_atendimento ADD CONSTRAINT dim_horario_ft_atendimento_fk
FOREIGN KEY (sk_horario)
REFERENCES public.dim_horario (sk_horario)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
